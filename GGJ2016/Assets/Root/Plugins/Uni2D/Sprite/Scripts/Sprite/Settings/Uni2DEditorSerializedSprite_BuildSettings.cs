...
public class Uni2DEditorSerializedSprite_BuildSettings
{
	...
	// Physic
	public SerializedSetting<DimensionMode> serializedDimensionMode       = null;
	...
	public SerializedSetting<bool> serializedOnlyBorder = null;
	public SerializedSetting<bool> serializedSubdivide = null;
	public SerializedSetting<int> serializedSubdivisionCount = null;
	...
	public void ApplyValues( )
	{
		...
		serializedOnlyBorder.Apply( );
		serializedSubdivide.Apply( );
		serializedSubdivisionCount.Apply( );
	...
	{
		return serializedDimensionMode.IsDefined
			|| serializedPhysicsMode.IsDefined
			...
			|| serializedOnlyBorder.IsDefined
			|| serializedSubdivide.IsDefined
			|| serializedSubdivisionCount.IsDefined;
	}

	public void RevertValues( )
	{
		serializedDimensionMode.Revert();
		...
		serializedOnlyBorder.Revert( );
		serializedSubdivide.Revert( );
		serializedSubdivisionCount.Revert( );
